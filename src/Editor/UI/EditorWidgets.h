...
bool ToolbarActionButton(EditorContext& context, const char* actionID, const char* icon = nullptr,
                         EditorWidgetVariant variant = EditorWidgetVariant::Neutral, bool sameLineAfter = true);
bool SvgIcon(EditorContext& context, const char* icon, float size = 16.0f, IconColor color = {235, 239, 246, 255});
bool IconButton(EditorContext& context, const char* id, const char* icon, const char* tooltip, bool enabled = true);
