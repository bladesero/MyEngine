...
ImVec4 MessageColor(EditorNotificationType type)
{
    ...
    switch (type) {
        case EditorNotificationType::Warning: return tokens.warning;
        case EditorNotificationType::Error: return tokens.dangerHovered;
        case EditorNotificationType::Success: return tokens.success;
        default: return tokens.mutedText;
    }
}
#endif
}
