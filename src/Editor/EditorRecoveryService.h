...
public:
    ...
    bool WriteSnapshot(const std::string& scenePath, uint64_t revision,
                       const std::string& serializedScene, std::string* error = nullptr);
    ...
    bool RemoveMatchingRevision(const std::string& scenePath, uint64_t revision,
