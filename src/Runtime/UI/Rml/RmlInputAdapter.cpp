...
bool RmlInputAdapter::ProcessEvent(Rml::Context& context, const Event& event) const {
    ...
    case EventType::KeyDown:
        return context.ProcessKeyDown(static_cast<Rml::Input::KeyIdentifier>(ToRmlKey(event.key.scancode)), modifiers);
    case EventType::KeyUp:
        return context.ProcessKeyUp(static_cast<Rml::Input::KeyIdentifier>(ToRmlKey(event.key.scancode)), modifiers);
    ...
    case EventType::MouseButtonDown:
        return context.ProcessMouseButtonDown(ToRmlMouseButton(event.mouseButton.button), modifiers);
    case EventType::MouseButtonUp:
        return context.ProcessMouseButtonUp(ToRmlMouseButton(event.mouseButton.button), modifiers);
    case EventType::MouseWheel:
        return context.ProcessMouseWheel(Rml::Vector2f(event.mouseWheel.x, event.mouseWheel.y), modifiers);
    default:
        return false;
    }
}
