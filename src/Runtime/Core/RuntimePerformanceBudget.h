...
struct RuntimePerformanceSample {
    ...
    double renderGraphRecordMs = 0.0;
    double renderGraphPrepareMs = 0.0;
    double renderGraphFinalizeMs = 0.0;
    double sceneCollectMs = 0.0;
    ...
    double uploadQueueMs = 0.0;
    double frameWaitMs = 0.0;
    double presentMs = 0.0;
    double editorUiMs = 0.0;
    double editorUiBuildMs = 0.0;
    double editorUiSubmitMs = 0.0;
    double platformWindowsMs = 0.0;
};
...
struct RuntimePerformanceSummary {
    ...
    double p50RenderMs = 0.0;
    double p95RenderMs = 0.0;
    double p95GpuMs = 0.0;
    double p95RenderSubmissionMs = 0.0;
    double p95ShadowCpuMs = 0.0;
    double p95MainCpuMs = 0.0;
    double p50RenderGraphBuildMs = 0.0;
    double p95RenderGraphBuildMs = 0.0;
    double p50RenderGraphExecuteMs = 0.0;
    double p95RenderGraphExecuteMs = 0.0;
    double p95RenderGraphRecordMs = 0.0;
    double p95RenderGraphPrepareMs = 0.0;
    double p95RenderGraphFinalizeMs = 0.0;
    double p95SceneCollectMs = 0.0;
    ...
    double p95UploadQueueMs = 0.0;
    double p95FrameWaitMs = 0.0;
    double p95PresentMs = 0.0;
    double p50EditorUiMs = 0.0;
    double p95EditorUiMs = 0.0;
    double p95EditorUiBuildMs = 0.0;
    double p95EditorUiSubmitMs = 0.0;
    double p95PlatformWindowsMs = 0.0;
