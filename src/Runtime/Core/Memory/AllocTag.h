...
inline const char* AllocTagToString(AllocTag tag) {
    switch (tag) {
        ...
        case AllocTag::Scene:       return "Scene";
        case AllocTag::Asset:       return "Asset";
        case AllocTag::Render:      return "Render";
        case AllocTag::FrameScratch:return "FrameScratch";
        case AllocTag::Pool:        return "Pool";
        case AllocTag::Test:        return "Test";
