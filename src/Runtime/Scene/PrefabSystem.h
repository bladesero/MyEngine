...
public:
    ...
    static ActorHandle QueueInstantiate(Scene& scene, const std::filesystem::path& path,
                                        const PrefabInstantiateOptions& options = {}, std::string* error = nullptr);
    ...
    static bool BuildOverrides(const Actor& instanceRoot, nlohmann::json& overrides, std::string* error = nullptr);
    static bool SetInstanceOverrides(Actor& instanceRoot, nlohmann::json overrides, std::string* error = nullptr);
    static bool ApplyOverridesToAsset(PrefabAsset& asset, const nlohmann::json& overrides,
    ...
    static bool RefreshInstances(Scene& scene, const std::string& prefabUuid, std::string* error = nullptr);
