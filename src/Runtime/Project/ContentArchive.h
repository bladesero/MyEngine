...
public:
    ...
    bool ReadFile(const std::string& path, std::vector<uint8_t>& out,
                  std::string* error = nullptr) const;
    bool ReadFileUncheckedAfterManifestValidated(
        const std::string& path,
        std::vector<uint8_t>& out,
        std::string* error = nullptr) const;
    bool ValidateAgainstManifest(const CookManifest& manifest,
                                 std::string* error = nullptr) const;
...
private:
    ...
    bool ReadFileInternal(const std::string& path, std::vector<uint8_t>& out,
                          bool verifyHash, std::string* error) const;
