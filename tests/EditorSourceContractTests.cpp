...
bool TestEditorOperatorSourceContracts() {
    ...
    if (!Check(!contextHeader.empty() && !panelHeader.empty() && !panelSource.empty() &&
               ...
               !projectSettings.empty() && !viewportPolicy.empty() &&
               !imguiBackend.empty() && !d3d11Context.empty() &&
    ...
    if (!Check(inspectorSections.find("RemoveComponentByType(context") != std::string::npos &&
               ...
               inspectorSections.find("EditorViewportPolicy::BindNextPopupToCurrentViewport()") != std::string::npos &&
    ...
    if (!Check(viewportPolicy.find("ImGui::GetMainViewport()") != std::string::npos &&
               ...
               "Editor multi-viewport ownership or D3D11 main-rect restoration regressed")) return false;
